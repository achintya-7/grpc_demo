...
const (
	JokeService_CreateJoke_FullMethodName = "/pb.JokeService/CreateJoke"
	JokeService_GetJoke_FullMethodName    = "/pb.JokeService/GetJoke"
)
...
func (c *jokeServiceClient) CreateJoke(ctx context.Context, in *CreateJokeRequest, opts ...grpc.CallOption) (*CreateJokeResponse, error) {
	...
	err := c.cc.Invoke(ctx, JokeService_CreateJoke_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _JokeService_CreateJoke_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: JokeService_CreateJoke_FullMethodName,
	}
