...
// All implementations should embed UnimplementedJokeServiceServer
...
// UnimplementedJokeServiceServer should be embedded to have forward compatible implementations.
